  ...
  return (
    <div className={`${isLightTheme ? "bg-white border-r border-gray-300" : "bg-[#111b21] border-r border-[#222d34]"} flex h-full flex-col`}>
      ...
      <div className={`${isLightTheme ? "bg-gray-100" : "bg-[#202c33]"} p-2`}>
        ...
        <div className="flex gap-2 mb-2 px-1 justify-start">
          <button
            onClick={() => setShowOnlyGiftMom(false)}
            className={`px-4 py-2 text-center transition-colors rounded-full text-sm font-medium ${
              !showOnlyGiftMom
                ? isLightTheme ? "bg-gray-200 text-gray-800" : "bg-[#1f2c33] text-white"
                : isLightTheme ? "bg-gray-100 text-gray-600" : "bg-transparent text-[#8696a0]"
            }`}
          >
            Todos
          </button>
          <button
            onClick={() => setShowOnlyGiftMom(true)}
            className={`px-4 py-2 text-center transition-colors rounded-full text-sm font-medium ${
              showOnlyGiftMom
                ? isLightTheme ? "bg-pink-500 text-white" : "bg-pink-700 text-white"
                : isLightTheme ? "bg-gray-100 text-gray-600" : "bg-transparent text-[#8696a0]"
            }`}
          >
            Mães
