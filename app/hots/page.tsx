...
export default function HotsPage() {
  ...
  // Placeholder for active panel - always hots on this page
  const [activePanel, setActivePanel] = useState<"chat" | "funil" | "hots" | "last24">("hots");
        ...
        <div className={`flex-1 ${isMobile ? "pb-16" : ""}`}>
          <div className={`h-full flex items-center justify-center ${isLightTheme ? "text-gray-700" : "text-[#aebac1]"}`}>
            <div className="text-center p-6">
              ...
              <h1 className="text-2xl font-bold mb-2">Hot Conversations</h1>
              <p className="text-lg">Here you will see popular conversations that need attention.</p>
